# 📘 Handleiding: jets-archive

**Type Website:** jets-type
...
| :--- | :--- |
| `config_id` | Geen beschrijving. |
| `site_naam` | Geen beschrijving. |
| `hero_header` | Geen beschrijving. |
| `hero_subtekst` | Geen beschrijving. |
| `logo_url` | Geen beschrijving. |

### Tabblad: `jets`

| Kolomnaam | Beschrijving |
| :--- | :--- |
| `id` | Geen beschrijving. |
| `name` | Geen beschrijving. |
| `full_name` | Geen beschrijving. |
| `manufacturer` | Geen beschrijving. |
| `origin` | Geen beschrijving. |
| `introduction_year` | Geen beschrijving. |
| `description` | Geen beschrijving. |
| `image_url` | Geen beschrijving. |
