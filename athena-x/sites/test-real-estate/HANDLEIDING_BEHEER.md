...
| `tagline` | Bv. 'Uw partner in wonen' |
| `beschrijving` | Geen beschrijving beschikbaar. |
| `adres` | Geen beschrijving beschikbaar. |
| `telefoon` | Geen beschrijving beschikbaar. |
| `email` | Geen beschrijving beschikbaar. |
...
| `type` | Huis, Appartement, Grond, Handelspand |
| `oppervlakte` | Bv. '150 m²' |
| `slaapkamers` | Geen beschrijving beschikbaar. |
| `beschrijving` | Geen beschrijving beschikbaar. |
| `status` | Te koop, Te huur, Verkocht |
| `epc_waarde` | Bv. 'A', 'B', '120 kWh/m²' |
...
| :--- | :--- |
| `naam` | Geen beschrijving beschikbaar. |
| `functie` | Geen beschrijving beschikbaar. |
| `telefoon_direct` | Geen beschrijving beschikbaar. |
