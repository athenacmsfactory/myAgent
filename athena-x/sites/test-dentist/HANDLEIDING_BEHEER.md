# 📘 Handleiding: test-dentist

**Type Website:** dentist
...
| `afspraak_url` | Geen beschrijving beschikbaar. |
| `hero_image_prompt` | Geen beschrijving beschikbaar. |

### Tabblad: `Behandelingen`

| Kolomnaam | Beschrijving |
| :--- | :--- |
| `naam` | Bv. 'Controle', 'Bleken', 'Implantaat' |
| `omschrijving` | Geen beschrijving beschikbaar. |
| `prijs_vanaf` | Geen beschrijving beschikbaar. |
...
| :--- | :--- |
| `naam` | Geen beschrijving beschikbaar. |
| `functie` | Tandarts, Assistent, Preventie-assistent |
