# 📘 Handleiding: academy-1

**Type Website:** academy
...
### Tabblad: `Academy_Info`

| Kolomnaam | Beschrijving |
| :--- | :--- |
| `naam` | Geen beschrijving beschikbaar. |
| `missie` | Geen beschrijving beschikbaar. |
| `locatie` | Geen beschrijving beschikbaar. |
| `contact_email` | Geen beschrijving beschikbaar. |
| `hero_image_prompt` | Geen beschrijving beschikbaar. |

### Tabblad: `Cursussen`

| Kolomnaam | Beschrijving |
| :--- | :--- |
| `titel` | Geen beschrijving beschikbaar. |
| `duur` | Geen beschrijving beschikbaar. |
| `niveau` | Bv. 'Beginner', 'Gevorderd' |
| `prijs` | Geen beschrijving beschikbaar. |
| `beschrijving` | Geen beschrijving beschikbaar. |
| `doelgroep` | Geen beschrijving beschikbaar. |
| `image_prompt` | Geen beschrijving beschikbaar. |
...
| :--- | :--- |
| `naam` | Geen beschrijving beschikbaar. |
| `expertise` | Geen beschrijving beschikbaar. |
| `bio` | Geen beschrijving beschikbaar. |
| `foto_prompt` | Geen beschrijving beschikbaar. |

### Tabblad: `Reviews`

| Kolomnaam | Beschrijving |
| :--- | :--- |
| `student_naam` | Geen beschrijving beschikbaar. |
| `cursus_naam` | Geen beschrijving beschikbaar. |
| `quote` | Geen beschrijving beschikbaar. |
