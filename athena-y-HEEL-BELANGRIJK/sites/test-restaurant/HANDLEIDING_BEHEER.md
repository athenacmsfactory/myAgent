...
### Tabblad: `Restaurant_Info`

| Kolomnaam | Beschrijving |
| :--- | :--- |
| `naam` | Geen beschrijving beschikbaar. |
| `keuken_type` | Bv. 'Italiaans', 'Frans-Belgisch' |
...
| `reserveren_url` | Geen beschrijving beschikbaar. |
...
| `categorie` | Bv. 'Voorgerechten', 'Hoofdgerechten', 'Desserts', 'Wijnen' |
| `dieet_info` | Bv. 'Vega', 'Vegan', 'Glutenvrij' |

### Tabblad: `Openingstijden`

| Kolomnaam | Beschrijving |
| :--- | :--- |
| `dag` | Geen beschrijving beschikbaar. |
| `uren` | Geen beschrijving beschikbaar. |

### Tabblad: `Socials`

| Kolomnaam | Beschrijving |
| :--- | :--- |
| `platform` | Geen beschrijving beschikbaar. |
