...
| `tagline` | Bv. 'De scherpste snit van de stad' |
| `beschrijving_kort` | Geen beschrijving beschikbaar. |
| `adres` | Geen beschrijving beschikbaar. |
| `telefoon` | Geen beschrijving beschikbaar. |
| `email` | Geen beschrijving beschikbaar. |
| `boekings_url` | Geen beschrijving beschikbaar. |
...
| :--- | :--- |
| `naam` | Geen beschrijving beschikbaar. |
| `omschrijving` | Geen beschrijving beschikbaar. |
| `prijs` | Geen beschrijving beschikbaar. |
| `duur` | Bv. '30 min' |
| `categorie` | Bv. 'Knippen', 'Scheren', 'Kind' |

### Tabblad: `Openingstijden`

| Kolomnaam | Beschrijving |
| :--- | :--- |
| `dag` | Maandag, Dinsdag, etc. |
| `uren` | Bv. '09:00 - 18:00' of 'Gesloten' |
...
| Kolomnaam | Beschrijving |
| :--- | :--- |
| `klant_naam` | Geen beschrijving beschikbaar. |
| `sterren` | 1 t/m 5 |
