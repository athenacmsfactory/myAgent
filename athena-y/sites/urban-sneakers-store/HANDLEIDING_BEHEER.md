# 📘 Handleiding: urban-sneakers-store
...
| `tagline` | Geen beschrijving beschikbaar. |
| `valuta` | Bv. '€' of '
...
*Gegenereerd door Athena Factory v6.0*
 |
| `verzend_info` | Geen beschrijving beschikbaar. |
...
| `afbeelding-url` | URL of pad naar productfoto (bv. /images/schoen.jpg) |
| `beschrijving` | Geen beschrijving beschikbaar. |
| `categorie` | Geen beschrijving beschikbaar. |
| `populair` | Ja/Nee |
