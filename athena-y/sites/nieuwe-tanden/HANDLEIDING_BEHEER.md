# 📘 Handleiding: nieuwe-tanden

**Type Website:** science-article-type
...
| :--- | :--- |
| `titel` | De titel van de website |
| `ondertitel` | Een korte beschrijving van de missie |
| `introductie` | Hoofdtekst voor de homepage |

### Tabblad: `evolutie_kaak`

| Kolomnaam | Beschrijving |
| :--- | :--- |
| `titel` | Titel van het artikel over kaakevolutie |
| `inhoud` | De volledige tekst over de invloed van voeding op kaakgroei |
| `onderzoeker` | Naam van de hoofdonderzoeker (bv. Corruccini of Ehrlich) |
| `afbeelding` | Relevante afbeelding of grafiek |

### Tabblad: `regeneratie_techniek`

| Kolomnaam | Beschrijving |
| :--- | :--- |
| `onderwerp` | Naam van de techniek of medicijn (bv. TRG-035 of Tideglusib) |
| `beschrijving` | Uitleg over hoe de regeneratie werkt |
| `status` | Huidige fase van het onderzoek (bv. Fase I klinische tests) |
| `tijdlijn` | Verwachte beschikbaarheid |

### Tabblad: `experts`

| Kolomnaam | Beschrijving |
| :--- | :--- |
| `naam` | Naam van de wetenschapper |
| `instituut` | Universiteit of ziekenhuis |
| `expertise` | Specifiek vakgebied |
