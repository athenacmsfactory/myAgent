# 📘 Handleiding: test-medical

**Type Website:** medical
...
| :--- | :--- |
| `naam` | Geen beschrijving beschikbaar. |
| `rol` | Geen beschrijving beschikbaar. |
...
| Kolomnaam | Beschrijving |
| :--- | :--- |
| `onderwerp` | Bv. 'Noodgeval', 'Huisbezoek' |
| `uitleg` | Geen beschrijving beschikbaar. |
